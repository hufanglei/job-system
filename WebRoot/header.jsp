...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="<%=basePath %>index.jsp" class="navbar-brand">招聘网</a>
		</div>
		<!--小屏幕导航按钮和logo-->
		<!--导航-->
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-left">
				...
				<li><a href="<%=basePath %>Company/frontlist">企业</a></li>
				<li><a href="<%=basePath %>JobType/frontlist">职位类别</a></li>
				<li><a href="<%=basePath %>Job/frontlist">职位</a></li>
				<li><a href="<%=basePath %>Delivery/frontlist">简历投递</a></li>
				<li><a href="<%=basePath %>JobRecord/frontlist">兼职记录</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a id="dLabel" type="button"
					...
					<ul class="dropdown-menu" aria-labelledby="dLabel">
						...
						<li><a href="<%=basePath %>index.jsp"><span
								class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布信息</a></li>
						<li><a href="<%=basePath %>index.jsp"><span
